...
function Travelerprofile() {
  ...
  useEffect(() => {
    const onHashChange = () => {
      ...
      setActive(h === "#past-trips" ? "#past-trips" : "#about");
    };
      ...
      <main className="container py-4 flex-grow-1">
        <div className="row g-4">
          ...
          <section className="col-12 col-lg-3">
            <div className="profile-sidebar">
              ...
              <div className="list-group">
                ...
                <a
                  href="#past-trips"
                  className={linkClass("#past-trips")} 
                  aria-current={active === "#past-trips" ? "true" : undefined}
                  onClick={() => setActive("#past-trips")}
                >
                  <span className="emoji_style item-icon d-inline-flex align-items-center justify-content-center">
                    🏠
                  </span>
                  <span className="fw-medium">Past Trips</span>
                </a>
              </div>
            </div>
          </section>
          ...
          <section className="col-12 col-lg-9">
            ...
            <div id="past-trips" className={active === "#past-trips" ? "" : "d-none"}>
              <PastTrips user={user} />
            </div>
          </section>
        </div>
